...
if __name__ == "__main__":
    ...
    image, final_code, original_code = get_code_content_with_space_for_image(image, code_region_list)
    for code_region in code_region_list:
         # cv2.imshow('123', image[code_region[0][1]:code_region[1][1], code_region[0][0]:code_region[1][0]])
         # cv2.waitKey(0)
    ...
    print("execution time is " + str(total_time) + "s")
